...
if [[ "$resposta" = 's' ]]; then
	...
	wget https://github.com/modderajuda/modderajudascript/blob/main/EasyRSA/cmake-2.8.12.tar.gz?raw=true
	...
	mkdir badvpn-build
	cd badvpn-build
	wget https://github.com/modderajuda/modderajudascript/blob/main/EasyRSA/badvpn-1.999.130.tar.gz?raw=true
